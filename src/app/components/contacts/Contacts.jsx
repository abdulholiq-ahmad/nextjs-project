...
const Contacts = () => {
  return (
    <div className="container mx-auto mt-[40px] mb-[30px]">
      <div className="flex flex-col gap-4 mb-[30px] ">
        <p className="text-[36px] text-[#000000] font-[600] text-center">Get In Touch With Us</p>
        <p className="text-[16px] text-[#9F9F9F] w-[633px] text-center m-auto">
          For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To
      ...
      <div className="w-[1058px]  py-[50px] px-[40px] flex gap-4 m-auto">
        ...
        <div className="flex flex-col gap-[36px] w-[50%]">
          <div className="flex flex-col gap-2">
            ...
            <input className="w-full py-2 border rounded-[10px] outline-none pl-3" placeholder="Abc" type="text" />
          </div>
          <div className="flex flex-col gap-2">
            <label htmlFor="">Email address</label>
            <input className="w-full py-2 border rounded-[10px] outline-none pl-3" placeholder="Abc@def.com" type="text" />
          </div>
          <div className="flex flex-col gap-2">
          ...
          <button className="w-[40%] py-2 bg-[#B88E2F] text-[#fff] rounded-[2px]">Submit</button>
        </div>
      </div>
    </div>
  );
